class UsersController < ApplicationController
  ...
  def edit
    ...
    if @user.id != session[:user_id]
      ...
      @login_url = "https://sandbox.dwolla.com/oauth/v2/authenticate?client_id=" + ENV["DWOLLA_APP_KEY"] + "&response_type=code&redirect_uri=http://localhost:3000/users/new&scope=Funding&dwolla_landing=login"
